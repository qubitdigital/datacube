...
import com.qubit.datacube.bucketers.EnumToOrdinalBucketer;
...
import com.qubit.datacube.backfill.HBaseBackfillMerger;
import com.qubit.datacube.backfill.HBaseSnapshotter;
import com.qubit.datacube.bucketers.HourDayMonthBucketer;
import com.qubit.datacube.idservices.HBaseIdService;
import com.qubit.datacube.ops.LongOp;
import com.qubit.datacube.ops.LongOp.LongOpDeserializer;
...
public class HBaseBackfillIntegrationTest extends EmbeddedClusterTestAbstract {
    ...
    private static DataCubeIo<LongOp> makeDataCubeIo(DataCube<LongOp> cube, byte[] table) 
        ...
        DbHarness<LongOp> dbHarness = new HBaseDbHarness<LongOp>(pool, ArrayUtils.EMPTY_BYTE_ARRAY,
                table, CF, LongOp.DESERIALIZER, idService, DbHarness.CommitType.INCREMENT);
