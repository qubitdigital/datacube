package com.qubit.datacube.tweetcountexample.tests;

import com.qubit.datacube.DbHarness;
import com.qubit.datacube.SyncLevel;
import com.qubit.datacube.dbharnesses.HBaseDbHarness;
import com.qubit.datacube.tweetcountexample.TweetCube;
import com.qubit.datacube.tweetcountexample.TweetIterator;
...
import com.qubit.datacube.EmbeddedClusterTestAbstract;
import com.qubit.datacube.IdService;
import com.qubit.datacube.idservices.HBaseIdService;
...
public class TweetCubeTests extends EmbeddedClusterTestAbstract {
	...
	private DbHarness<LongOp> getHBaseHarness(Configuration conf) throws Exception {
		...
		return new HBaseDbHarness<LongOp>(hTablePool,
				...
				idService, 
				DbHarness.CommitType.INCREMENT, // Use native HBase increments for mutations
