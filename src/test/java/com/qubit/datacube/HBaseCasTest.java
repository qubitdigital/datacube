...
/**
 * Test using HBaseDbHarness with {@link DbHarness.CommitType#READ_COMBINE_CAS}.
 * 
...
public class HBaseCasTest extends EmbeddedClusterTestAbstract {
    ...
    public void test() throws Exception {
        ...
        DbHarness<BytesOp> dbHarness = new HBaseDbHarness<BytesOp>(pool, ArrayUtils.EMPTY_BYTE_ARRAY,
                tableName, cfName,  new BytesOpDeserializer(), idService, DbHarness.CommitType.READ_COMBINE_CAS,
                3, 20, 20, "testscope");
