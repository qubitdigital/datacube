...
import com.qubit.datacube.bucketers.BigEndianLongBucketer;
...
/**
 * Check that {@link DbHarness.CommitType#OVERWRITE} works.
 */
public class HBaseOverwriteTest extends EmbeddedClusterTestAbstract {
    ...
    public void test() throws Exception {
        ...
        DbHarness<BytesOp> dbHarness = new HBaseDbHarness<BytesOp>(pool, ArrayUtils.EMPTY_BYTE_ARRAY,
                tableName, cfName,  new BytesOpDeserializer(), idService, DbHarness.CommitType.OVERWRITE);
    ...
    public void testSetGet() throws Exception {
        ...
        HTablePool pool = new HTablePool(getTestUtil().getConfiguration(), Integer.MAX_VALUE);
        DbHarness<BytesOp> dbHarness = new HBaseDbHarness<BytesOp>(pool, ArrayUtils.EMPTY_BYTE_ARRAY,
                tableName, cfName, new BytesOpDeserializer(), idService, DbHarness.CommitType.INCREMENT);
